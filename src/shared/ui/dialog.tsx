...
const DIALOG_SIZE = {
  sm: "sm:max-w-sm", // 384px — simple confirm / tiny forms
  md: "sm:max-w-md", // 448px — small forms
  lg: "sm:max-w-2xl", // 672px — default, comfortable content
  xl: "sm:max-w-3xl", // 768px — wider content / wizards
  "2xl": "sm:max-w-5xl", // 1024px — tables / data-heavy
  "3xl": "sm:max-w-6xl", // 1152px — extra wide
  full: "sm:max-w-7xl", // 1280px — full-width forms
} as const;

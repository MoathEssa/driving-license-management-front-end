  ...
  return (
    <div className="relative flex min-h-screen bg-background overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-2/5 flex-col items-center justify-center bg-primary text-primary-foreground p-12 relative overflow-hidden">
        ...
        <div className="absolute -bottom-32 -right-32 w-[28rem] h-[28rem] rounded-full bg-primary-foreground/5" />
        <div className="absolute top-1/2 -right-16 w-64 h-64 rounded-full bg-primary-foreground/5" />

        <div className="relative z-10 flex flex-col items-center text-center gap-6 max-w-xs">
          <div className="flex items-center justify-center w-20 h-20 rounded-2xl bg-primary-foreground/15 backdrop-blur-sm ring-1 ring-primary-foreground/20 shadow-xl">
